...
<head>
 ...
 ?>
 <title><?php echo e($adminSetting ? $adminSetting->longtext : 'Game'); ?></title>
 ...
 <style>
  .imagebackground{
  background-image: url("<?php echo e(asset('assets/auth_bg.png')); ?>");
     ...
     <div data-v-81ead1cb="" class=" wc" style="background:none;">
      <div data-v-81ead1cb="" class="navbar__content" style=":#2a8ff3;">
       ...
       <div data-v-81ead1cb="" class="navbar__content-center" style=":#2a8ff3;">
        ...
        <h2 style="color : white; font-weight: bold; font-size: 20px;"> <?php echo e($adminSetting ? $adminSetting->longtext : 'Game'); ?> </h2>
       </div>
       <div data-v-81ead1cb="" class="navbar__content-title"></div>
      </div>
      <div data-v-81ead1cb="" class="navbar__content-right" style=":#2a8ff3;">
       <form action="<?php echo e(route('user_register',$ref_id->referral_code)); ?>" method="post">
        <?php echo csrf_field(); ?>
      </div>
     </div>
    </div>
    ...
    <div data-v-183fb3f9="" class="dropdown__value" style="background:white; border-radius:10px; height: 70%; display: flex; align-items: center; padding: 5px;margin-top:10px">
        <select  id="phone_code" name="phone_code" style="height:; border: none; padding: 5px; font-size: 14px; flex: 1;outline:none">
            <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $countries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($countries->phone_code); ?>"><?php echo e($countries->phone_code); ?></option>
...
$message = $__bag->first($__errorArgs[0]); ?>
       <div class="alert alert-warning" style="color: red;"><?php echo e($message); ?></div>
       <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
      ...
      <div data-v-327ab6b4="" class="register__container-invitation">
       ...
       <div data-v-327ab6b4="" class="register__container-invitation__input">
        <input class="inviteCode" data-v-327ab6b4="" name="referral_code" value="<?php echo e($ref_id->referral_code); ?>" type="text" auto-complete="new-password" style="color:black;background:white" autocomplete="off" name="userNumber" placeholder="Please enter your email" disabled="" maxlength="40" required>
       </div>
      </div>
      ...
      <div data-v-327ab6b4="" class="register__container-button">
       ...
       <a href="https://globalbet24.club/" style="
               width: 7.73333rem;
               height: 1.06667rem;
               color: #fff;
               font-size: .48rem;
...
</html><?php /**PATH /home/u483840386/domains/globalbet24.club/public_html/root/resources/views/user/newregister.blade.php ENDPATH**/ ?>